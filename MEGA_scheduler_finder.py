...
scheduler_list = ['linear', 'polynomial', 'inverse_sqrt', 'cosine', 'cosine_with_restarts']
...
for scheduler_name in scheduler_list:
    ...
    for seed in tqdm(range(N_SEEDS)):
        ...
        scheduler = get_scheduler(name=scheduler_name, optimizer=optimizer, num_warmup_steps=1, num_training_steps=N_EPOCHS*len(train_dataloader))
